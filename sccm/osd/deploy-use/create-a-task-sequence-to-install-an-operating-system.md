...
description: "Za pomocą sekwencji zadań w programie System Center Configuration Manager do automatycznego zainstalowania obrazu systemu operacyjnego i innych treści na komputerze docelowym."
ms.custom: na
ms.date: 10/06/2016
...
6.  Na stronie **Instalowanie systemu Windows** określ poniższe ustawienia, a następnie kliknij przycisk **Dalej**.  
    ...
    -   **Pakiet obrazów**: Określ pakiet, który zawiera obraz systemu operacyjnego do zainstalowania. Aby uzyskać więcej informacji, zobacz [zarządzania obrazami systemu operacyjnego](../get-started/manage-operating-system-images.md).  
    ...
    -   **Podziel na partycje i sformatuj dysk komputera docelowego instalującego system operacyjny**: Określ, czy sekwencja zadań na partycje i sformatuj dysk komputera docelowego przed zainstalowaniem systemu operacyjnego.  
    ...
    -   Określ, w jaki sposób ma być obsługiwane konto administratora używane podczas wdrażania obrazu systemu operacyjnego.  
        ...
        -   **Zawsze używaj tego samego hasła administratora**: Określ, czy to samo hasło jest używane dla konta administratora lokalnego na wszystkich komputerach, na których jest wdrażany system operacyjny.  
...
9. Na stronie **Migracja stanu** określ poniższe informacje, a następnie kliknij przycisk **Dalej**.  
    ...
    -   **Przechwyć ustawienia użytkownika**: Określ, czy sekwencja zadań przechwytuje stan użytkownika. Aby uzyskać więcej informacji o sposobie przechwytywania i przywracania stanu użytkownika, zobacz [zarządzania stanem użytkownika](../get-started/manage-user-state.md).  

    -   **Przechwyć ustawienia sieci**: Określ, czy sekwencja zadań przechwytuje ustawienia sieci z komputera docelowego. Oprócz ustawień karty sieciowej można przechwycić członkostwo domeny lub grupy roboczej.  

    -   **Przechwyć ustawienia Microsoft Windows**:  Określ, czy sekwencja zadań przechwytuje ustawienia systemu Windows z komputera docelowego przed zainstalowaniem obrazu systemu operacyjnego. Można przechwycić nazwy komputera, zarejestrowanego użytkownika i organizacji oraz ustawienia strefy czasowej.  
...
|---------------------------------|-----------------|  
|Przechwytywanie plików i ustawień - **(nowe grupy sekwencji zadań)**|Umożliwia utworzenie grupy sekwencji zadań. Grupa sekwencji zadań zawiera podobne kroki sekwencji zadań w celu zapewnienia lepszej organizacji i kontroli błędów.<br /><br /> Ta grupa zawiera kroki niezbędne do przechwytywania plików i ustawień z systemu operacyjnego komputera odniesienia.|  
...
|Przechwyć pliki użytkownika i ustawienia|Użyj tego kroku sekwencji zadań, aby użyć narzędzia migracji stanu użytkowników (USMT) do przechwytywania stanu i ustawień użytkownika z komputera odniesienia, która odbierze sekwencję zadań skojarzonych z tym krokiem zadań. Można przechwytywać opcje standardowe lub skonfigurować opcje do przechwytywania.|  
...
|Zainstaluj System operacyjny - **(nowe grupy sekwencji zadań)**|Utwórz następną podgrupę sekwencji zadań. Podrzędna grupa zawiera kroki niezbędne do zainstalowania i skonfigurowania środowiska Windows PE.|  
...
|Konfiguracja systemu operacyjnego - **(nowe grupy sekwencji zadań)**|Utwórz następną podgrupę sekwencji zadań. Podrzędna grupa zawiera kroki niezbędne do konfigurowania zainstalowanego systemu operacyjnego.|  
...
|Zainstaluj aktualizacje|Ten krok sekwencji zadań umożliwia określenie sposobu instalacji aktualizacji oprogramowania na komputerze docelowym. Komputer docelowy nie jest sprawdzany pod kątem dostępności odpowiednich aktualizacji oprogramowania do czasu uruchomienia tego kroku sekwencji zadań. W tym momencie komputer docelowy jest sprawdzany pod kątem aktualizacji oprogramowania, podobnie jak inne klient zarządzany przez Menedżera konfiguracji.<br /><br /> W tym kroku jest używana zmienna sekwencji zadań tylko do odczytu **_SMSTSMediaType** . Ten krok sekwencji jest wykonywany tylko wtedy, gdy wartość zmiennej nie jest równa **FullMedia**.|  
|Przywracanie plików użytkownika oraz ustawień - **(nowe Grupa sekwencji zadań podrzędnych)**|Utwórz następną podgrupę sekwencji zadań. Podrzędna grupa zawiera kroki potrzebne do przywrócenia plików i ustawień użytkownika.|  
